...
. Download the latest [path]_MacPorts-2.4.3-....pkg_ installer from the releases link:on GitHub. Here are direct links for the latest versions of macOS:
+
 macOS 10.13 High Sierra: ::
link:MacPorts-2.4.3-10.13-HighSierra.pkg
 macOS 10.12 Sierra: ::
link:MacPorts-2.4.3-10.12-Sierra.pkg
 OS X 10.11 El Capitan: ::
link:MacPorts-2.4.3-10.11-ElCapitan.pkg
...
. Download and extract the link: MacPorts 2.4.3 tarball. Either do so using your browser and the Finder, or use the given commands in a terminal window.
+
